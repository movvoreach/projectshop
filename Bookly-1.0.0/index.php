          ...
          <div class="swiper-slide">
            <div class="card position-relative p-4 border rounded-3">
              <div class="position-absolute">
                <p class="bg-primary py-1 px-3 fs-6 text-white rounded-2"><?php echo $row['dis'] ?>% </p>
              </div>
              <img src="../Admin/img/<?php echo $row['photo']; ?>" class="img-fluid shadow-sm" >
              <h6 class="mt-4 mb-0 fw-bold"><a href="index.html"></a><?php echo $row['Name']; ?></h6>
              ...
              <span class="price text-primary fw-bold mb-2 fs-5">$<?php echo $row['price_dis']; ?> <del style="float:right"><?php echo $row['price'] ?>$</del></span>
              <div class="card-concern position-absolute start-0 end-0 d-flex gap-2">
                <button type="button" href="#" class="btn btn-dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to cart">
                  <svg class="cart">
                    <use xlink:href="#cart"></use>
                  </svg>
                </button>
